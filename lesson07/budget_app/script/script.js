...
let idElem = document.getElementById('start'),
    ...
    inputExpMonth = document.getElementsByClassName('expenses_month-value'),
    inputIncome = document.getElementsByClassName('additional_income-value'),
    inputAddExp = document.getElementsByClassName('additional_expenses-value'),
    inputPeriodIncome = document.getElementsByClassName('income_period-value'),
    inputTarget = document.getElementsByClassName('target_month-value');
